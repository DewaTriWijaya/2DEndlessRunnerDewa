...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    private GameObject GenerateFromPool(GameObject item, Transform parent)
    {
        ...
        {
            // if itekm list not defined, create new one
    ...
    private void OnDrawGizmos()
    {
        ...
        Debug.DrawLine(areaStartPosition + Vector3.up * debugLineWidth / 2, areaStartPosition + Vector3.down * debugLineWidth / 2, Color.red);
        Debug.DrawLine(areaEndPosition + Vector3.up * debugLineWidth / 2, areaEndPosition + Vector3.down * debugLineWidth / 2, Color.red);
    }
}
